...
class EditAsset(forms.ModelForm):  
    class Meta:
        ...
        fields =  [
            ...
            "person_responsible", "person_responsible_email", "requires_calibration", "calibration_instructions", "calibration_records", 
            "calibration_date_prev", "calibration_date_next", "requires_insurance", "requires_safety_checks", "requires_environmental_checks", 
            "requires_planned_maintenance", "maintenance_instructions", "maintenance_records", "asset_value", "purchase_order_ref", "funded_by", 
            "acquired_on", "related_to_other_asset", "asset_location_building", "asset_location_room", "asset_operating_instructions",
