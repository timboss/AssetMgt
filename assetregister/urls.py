...
urlpatterns = [
    ...
    url(r'^calibration/export/all/nextmonth/$', views.calibration_asset_export_nextmonth, name="calibration_asset_export_nextmonth"),
    url(r'^calibration/export/custom/$', views.calibration_asset_export_custom, name="calibration_asset_export_custom"),
    url(r'^calibration/export/$', views.calibration_asset_export_custom_select, name="calibration_asset_export_custom_select"),
