...
urlpatterns = [
    ...
    url(r'^location/(?P<pk>\d+)/move_asset/$', views.move_asset_to_qr_location, name="move_asset_to_qr_location"),
    url(r'^location/(?P<pk>\d+)/edit/$', views.edit_qr_location, name="edit_qr_location"),
    url(r'^location/(?P<pk>\d+)/qr/$', views.location_qr, name="location_qr"),
    url(r'^location/bulk_reserve/$', views.reserve_qr_locations, name="reserve_qr_locations"),
    # url(r'^location(?P<pk>\d+)/$', views.asset_edit, name="asset_edit"),
