...
urlpatterns = [
    ...
    url(r'^calibration/export/records/$', views.export_all_calibrations, name="export_calibration_records"),
    ...
    url(r'^asset/bulk_reserve/print/(?P<id_from>\d+)/(?P<id_to>\d+)/$', views.print_asset_labels, name="print_asset_labels"),
    ...
    url(r'^location/$', views.qr_location_list, name="qr_location_list"),
    url(r'^location/new$', views.new_qr_location, name="new_qr_location"),
    url(r'^location/(?P<pk>\d+)/edit/$', views.edit_qr_location, name="edit_qr_location"),
    url(r'^location/(?P<pk>\d+)/qr/$', views.qr_location_qr, name="qr_location_qr"),
    url(r'^location/(?P<pk>\d+)/view/$', views.qr_location_view_assets, name="qr_location_view_assets"),
    url(r'^location/(?P<pk>\d+)/$', views.move_asset_to_qr_location, name="move_asset_to_qr_location"),
    url(r'^location/bulk_reserve/$', views.reserve_qr_locations, name="reserve_qr_locations"),
    url(r'^location/bulk_reserve/print/(?P<id_from>\d+)/(?P<id_to>\d+)/$', views.print_location_labels, name="print_location_labels"),
